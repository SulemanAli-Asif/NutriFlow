...
const Section_7 = () => {
    return (
        <div className='w-full bg-sky-50 lg:h-[624px] px-2 pt-10 lg:pt-0 h-auto'>
            <div id='about-main' className="w-7/12 mx-auto grid grid-cols-1 lg:grid-cols-2 justify-items-center h-full">
            <div className=''>
                    <img id='about-img' src="/images/daily-plan.webp" className='h-[572px]'  alt="" />
                </div>
